...
parser.add_argument('--dataset', default='SUN', help='AWA,AWA2,CUB,SUN,APY')
parser.add_argument('--dataroot', default='./dataset', help='path to data')
parser.add_argument('--image_embedding', default='res101')
parser.add_argument('--class_embedding', default='att')
parser.add_argument('--att_dim',default=102,help='att dim of dataset')
parser.add_argument('--noise_dim',default=102,help='noise dim setting')
...
parser.add_argument('--nclass',default=717,help='the number of classes for dataset')
parser.add_argument('--reseen_classes',default=600,help='the number of resplit seen classes for dataset')
parser.add_argument('--reunseen_classes',default=45,help='the number of resplit unseen classes for dataset')
...
parser.add_argument('--syn_seen_num',default=500,help='the number of generated seen samples')
parser.add_argument('--syn_unseen_num',default=500,help='the number of generated seen samples')
...
for epoch in range(opt.nepoch):
    ...
    for i in range(0,data.ntrain,opt.batch_size):
        ...
        for iter_g in range(opt.gen_epoch):
            ...
            G_loss = -criticG_fake + 0.2 * cls_fake + 0.1 * cls_real + 0.1 * mapping_loss + ortho_loss * 1e-9
            G_loss.backward()
...
sio.savemat('saved.mat',{'orl_loss':loss})